...
import com.willie.cloud.vod.repository.base.impl.BaseRepositoryImpl;
 ...
 **************************************************/
@Repository
public class VideoRepositoryImpl extends BaseRepositoryImpl<Video, Integer> implements CustomRepository {
...
//        String jpql = " select t from Video as t where t.videoId is not null ";
        ...
        Page<Video> videoPage = createNativeBasePage(sql, pageable);
//        Page<Video> videoPage = createBasePage(jpql, pageable);
        return videoPage;
    }
}
